...
export function hashPassword(password: string): Promise<string> {
  ...
  return argon2.hash(password, { ...ARGON_OPTIONS, raw: false }) as Promise<string>;
}
 ...
 */
const DUMMY_HASH =
  "$argon2id$v=19$m=19456,t=2,p=1$c29tZXNhbHRzb21lc2FsdA$JXPxYlEJv8nHqLKvJj4kZ9dGxJKGvKZJhCJvY0Xy1sA";
