 ...
 */
async function fetchFundingTransaction(signature) {
 ...
 */
export async function verifyFundingTransaction(signature, creatorAddress) {
    ...
    if (credited !== TASK_PRICE_LAMPORTS) {
        throw badRequest(`Expected a transfer of ${TASK_PRICE_LAMPORTS} lamports, saw ${credited}`, "WRONG_AMOUNT", { expected: TASK_PRICE_LAMPORTS, received: credited });
    }
...
export async function listCreatorTasks(userId) {
...
export async function getCreatorTask(userId, taskId) {
...
export async function getTaskResults(userId, taskId) {
