 ...
 */
export async function submitTask(workerId, taskId, optionId, context) {
...
export async function getWorkerBalance(workerId) {
...
export async function listWorkerSubmissions(workerId) {
...
export async function getWorkerEarnings(workerId, page, limit) {
