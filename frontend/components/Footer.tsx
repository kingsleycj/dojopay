                ...
                <div className="flex items-center gap-2">
                    <svg className="w-5 h-5 sm:w-7 sm:h-7" viewBox="0 0 397.7 311.7" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            ...
                            <linearGradient id="solanaGradient2" x1="264.829" y1="401.601" x2="45.163" y2="-19.1475" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stopColor="#00FFA3"/>
                                <stop offset="1" stopColor="#DC1FFF"/>
                            </linearGradient>
                            <linearGradient id="solanaGradient3" x1="312.548" y1="376.688" x2="92.8822" y2="-44.061" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stopColor="#00FFA3"/>
                                <stop offset="1" stopColor="#DC1FFF"/>
                            </linearGradient>
                        </defs>
                        ...
                        <path d="M333.1 120.1c-2.4-2.4-5.7-3.8-9.2-3.8H6.5c-5.8 0-8.7 7-4.6 11.1l62.7 62.7c2.4 2.4 5.7 3.8 9.2 3.8h317.4c5.8 0 8.7-7 4.6-11.1l-62.7-62.7z" fill="url(#solanaGradient3)"/>
                    </svg>
                </div>
            </div>
        </footer>
