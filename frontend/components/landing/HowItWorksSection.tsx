      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Three steps to connect task creators with global workers—powered by
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Post data labeling jobs, micro-tasks, or bounties. Set your
              budget, define requirements, and launch in minutes.
            </p>
          </div>
          <div className="text-center">
            <div className="w-14 h-14 bg-gray-900 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6 ring-4 ring-[#fff7ed]">
            ...
            <p className="text-gray-600 leading-relaxed">
              Workers browse available tasks, complete high-quality work, and
              submit for verification in a streamlined workflow.
            </p>
          </div>
          <div className="text-center">
            <div className="w-14 h-14 bg-gray-900 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6 ring-4 ring-[#fff7ed]">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-gray-900">
              Earn Instantly in SOL
            </h3>
            <p className="text-gray-600 leading-relaxed">
              Upon approval, workers receive instant payment in SOL. No delays,
